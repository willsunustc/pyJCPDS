...
'''
modified from ds_jcpds/jcpds.py in peakpo[S.-H. Shim (2017) PeakPo 
- A python software for X-ray diffraction analysis at high pressure and 
high temperature. Zenodo. http://doi.org/10.5281/zenodo.810199] to operate 
more common version-4 jcpds files with prefixed keywords.
'''
